...
abstract class HextraceModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HextraceModDependenciesExtension>("hextraceModDependencies")
